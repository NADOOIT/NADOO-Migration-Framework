...
class FixProjectStructureMigration(MigrationBase):
    ...
    def migrate(self) -> None:
        ...
        merged_toml["project"].update(
            {
                ...
                "authors": [{"name": "NADOO", "email": "info@nadoo.ai"}],
            }
        )
        ...
        merged_toml["tool"]["poetry"].setdefault("group", {}).setdefault("test", {}).setdefault(
            "dependencies", {}
        ).update({"pytest": "^7.0.0", "pytest-cov": "^4.0.0", "pytest-asyncio": "^0.21.0"})
