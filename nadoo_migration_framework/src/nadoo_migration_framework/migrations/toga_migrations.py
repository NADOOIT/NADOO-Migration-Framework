...
class SeparateViewLogicMigration(Migration):
    ...
    def get_state(self) -> Dict:
        ...
        return {
            ...
            "transformations": [
                {"view_file": t.view_file, "logic_file": t.logic_file, "description": t.description}
...
class UpdateViewImportsMigration(Migration):
    ...
    def _up(self) -> None:
        ...
        old_to_new = {"views": "logic", "utils": "logic.utils", "helpers": "logic.helpers"}
    ...
    def get_state(self) -> Dict:
        """Get the current state of the migration."""
        return {"version": self.version, "original_states": self.original_states}
