...
class VersionCompatibilityMatrix:
    ...
    def _load_requirements(self):
        ...
        self.framework_requirements["toga"] = {
            "0.3.0": VersionRequirement(
                ...
                required_dependencies={"briefcase": ">=0.3.14", "libcst": ">=1.0.0"},
            ),
            "0.3.3": VersionRequirement(
                min_version="0.3.3",
                max_version="0.4.0",
                required_dependencies={"briefcase": ">=0.3.15", "libcst": ">=1.1.0"},
            ),
        }
        ...
        self.template_requirements["toga-single"] = {
            "0.3.0": VersionRequirement(
                min_version="0.3.0",
                max_version="0.3.3",
                required_dependencies={"toga": ">=0.3.0", "briefcase": ">=0.3.14"},
            )
        }
    ...
    def get_compatible_versions(self, framework: str, current_version: str) -> List[str]:
    ...
    def get_required_dependencies(self, framework: str, version: str) -> Dict[str, str]:
        ...
        """
        if (
            framework in self.framework_requirements
            and version in self.framework_requirements[framework]
        ):
