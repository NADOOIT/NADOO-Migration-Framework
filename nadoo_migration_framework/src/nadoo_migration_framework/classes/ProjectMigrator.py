...
from ..functions.create_standard_directory_structure_for_path import (
    create_standard_directory_structure_for_path,
)
from ..functions.extract_function_from_file_to_new_file import (
...
class ProjectMigrator:
    def __init__(self, project_path: str, app_name: str = None, app_formal_name: str = None):
        ...
        self.app_formal_name = app_formal_name or ' '.join(
            word.capitalize() for word in self.app_name.split('_')
        )
                ...
                with open(func_file, 'r', encoding='utf-8') as f:
                    ...
                    for line in content.split('\n'):
                        if line.strip().startswith('def '):
                            ...
                            new_file = extract_function_from_file_to_new_file(
                                func_file, func_name, functions_dir
                            )
                            if new_file:
