...
class DependencyManager:
            ...
            with open(self.pyproject_path) as f:
                ...
                for dep in deps:
                    ...
                    self.dependencies[name] = DependencyRequirement(
                        name=name, min_version=min_ver, max_version=max_ver
                    )
    ...
    def add_dependency(
        self, name: str, min_version: str, max_version: Optional[str] = None, optional: bool = False
    ) -> None:
        ...
        """
        self.dependencies[name] = DependencyRequirement(
            name=name, min_version=min_version, max_version=max_version or "*", optional=optional
        )
