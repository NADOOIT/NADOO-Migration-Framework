...
class TemplateManager:
    ...
    def _load_builtin_templates(self) -> None:
        ...
        toga_single = MigrationTemplate(
            "toga-single", "Migration template for single-window Toga applications"
        )
        toga_single.add_migration(
            "nadoo_migration_framework.migrations.CreateFunctionDirectoryMigration"
        )
        toga_single.add_migration(
            "nadoo_migration_framework.migrations.ExtractCurriedFunctionsMigration"
        )
        toga_single.add_migration(
            "nadoo_migration_framework.migrations.ExtractRegularFunctionsMigration"
        )
        toga_single.add_migration(
            "nadoo_migration_framework.migrations.ConsolidateImportsMigration"
        )
        self.templates["toga-single"] = toga_single

        # Toga Multi Window Template
        toga_multi = MigrationTemplate(
            "toga-multi", "Migration template for multi-window Toga applications"
        )
        toga_multi.add_migration(
            "nadoo_migration_framework.migrations.CreateFunctionDirectoryMigration"
        )
        toga_multi.add_migration(
            "nadoo_migration_framework.migrations.ExtractCurriedFunctionsMigration"
