...
'''
    ...
    with open(os.path.join(nested_app_dir, 'src', 'app3', 'functions', 'test_function3.py'), 'w') as f:
        f.write(test_func3)
...
'''
    ...
    with open(os.path.join(os.path.join(test_apps, 'app1'), 'src', 'app1', 'functions', 'shared_function.py'), 'w') as f:
