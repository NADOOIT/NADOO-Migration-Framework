...
def test_detect_project_structure(tmp_path):
    ...
    underscore_path = create_test_project(tmp_path / "underscore", ProjectStructure.BRIEFCASE_UNDERSCORE, "test_app")
...
def test_update_imports(tmp_path):
    ...
    update_imports(str(test_file), "test_app", ProjectStructure.LEGACY, ProjectStructure.BRIEFCASE_UNDERSCORE)
    ...
    update_imports(str(test_file), "test-app", ProjectStructure.BRIEFCASE_DASH, ProjectStructure.BRIEFCASE_UNDERSCORE)
...
def test_migrate_project(tmp_path):
    ...
    legacy_path = create_test_project(tmp_path / "test_project", ProjectStructure.LEGACY, "test_app")
...
def test_migrate_dash_to_underscore(tmp_path):
    ...
    dash_path = create_test_project(tmp_path / "test_project", ProjectStructure.BRIEFCASE_DASH, "test-app")
