...
def test_zmq_basic_communication(feed_manager, mock_apps):
    ...
    test_message = {"action": "create_element", "element_id": "test_element", "data": {"value": 42}}
...
def test_zmq_high_frequency_messages(feed_manager, mock_apps):
    ...
    for i in range(num_messages):
        message = {"action": "update", "element_id": f"element_{i}", "data": {"value": i}}
...
def test_zmq_large_payload(feed_manager, mock_apps):
    ...
    message = {"action": "create_element", "element_id": "large_element", "data": large_data}
