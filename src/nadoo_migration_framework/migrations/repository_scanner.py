...
class RepositoryScanner:
    ...
    def is_fork(self, path: str) -> bool:
        ...
        try:
            ...
            return "Fetch URL:" in repo_info and "Push  URL:" in repo_info and "HEAD branch:" in repo_info
    ...
    def migrate_repositories(self, target_structure: ProjectStructure = ProjectStructure.BRIEFCASE_UNDERSCORE) -> None:
