            ...
            if not updated_node.get_docstring():
                ...
                if updated_node.params.params:
                    ...
                    for param in updated_node.params.params:
                        ...
                        annotation = param.annotation.annotation.value if param.annotation else "Any"
                        docstring += f"    {param_name} ({annotation}): Description of {param_name}.\n"
                    docstring += '"""\n'
                ...
                new_body = [doc_node] + (updated_node.body.body if isinstance(updated_node.body, cst.IndentedBlock) else [])
