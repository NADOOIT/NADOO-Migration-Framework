...
class PerformanceMonitor(cst.CSTTransformer):
                        ...
                        body=cst.IndentedBlock([
                            cst.FunctionDef(
                                ...
                                body=cst.IndentedBlock([
                                    ...
                                    cst.Assign(
                                        targets=[cst.AssignTarget(target=cst.Name("start_memory"))],
                                        value=cst.Call(
                                            func=cst.Attribute(
                                        ...
                                        body=cst.IndentedBlock([
                                            cst.Assign(
                                                ...
                                                value=cst.Call(
                                                    func=cst.Name("func"),
                                                    args=[
                                                        cst.Arg(value=cst.Name("args"), star="*"),
                                                        cst.Arg(value=cst.Name("kwargs"), star="**"),
                                                    ],
                                                ),
                                            ),
                                        ]),
                                                            ...
                                                            args=[
                                                                cst.Arg(
                                                                    value=cst.FormattedString(
                                                                        parts=[
                                                                            cst.FormattedStringText("Error in "),
                                                                            cst.FormattedStringExpression(
                                                                                expression=cst.Attribute(
                                                                                    value=cst.Name("func"),
                                                                                    attr=cst.Name("__name__"),
                                                                                ),
                                                                            ),
                                                                            cst.FormattedStringText(": "),
                                                                            cst.FormattedStringExpression(
                                                                                expression=cst.Name("e"),
                                                                            ),
                                                                        ],
                                                                    ),
                                                                ),
                                                ...
                                                value=cst.Call(
                                                    ...
                                                    args=[
                                                        cst.Arg(
                                                            value=cst.FormattedString(
                                                                parts=[
                                                                    cst.FormattedStringText("Performance metrics for "),
                                                                    cst.FormattedStringExpression(
                                                                        expression=cst.Attribute(
                                                                            value=cst.Name("func"),
                                                                            attr=cst.Name("__name__"),
                                                                    ...
                                                                    cst.FormattedStringExpression(
                                                                        expression=cst.BinaryOperation(
                                                                            ...
                                                                            operator=cst.Minus(),
                                                                            right=cst.Name("start_time"),
                                                                        ),
                                                                    ),
                                                                    cst.FormattedStringText(" seconds\\n"),
                                                                    cst.FormattedStringText("  Memory: "),
                                                                    cst.FormattedStringExpression(
                                                                        expression=cst.Call(
                                                                            func=cst.Attribute(
                                                                                value=cst.Name("start_memory"),
                                                                                attr=cst.Name("memory_info"),
                                                                            ),
                                                                            args=[],
                                                                        ),
                                                                    ),
    ...
    def leave_FunctionDef(self, original_node: cst.FunctionDef, updated_node: cst.FunctionDef) -> cst.FunctionDef:
        ...
        if updated_node.name.value in self.monitored_functions or updated_node.name.value.startswith('__'):
            return updated_node
