...
class MigrationEngine:
    ...
    def __init__(self, project_dir: Path):
        ...
        self.compatibility_checker = CompatibilityChecker(project_dir)  # Initialize compatibility checker
    ...
    def check_migrations(self) -> List[str]:
        ...
        if current_version and Version.from_string(current_version) < Version.from_string(self.LATEST_VERSION):
